        ...
        <div class="guide-body protocol-body">
          ...
          <details class="protocol-details" open>
            ...
            <div class="manual-grid">
              ...
              <section><h3>歩行と解析側</h3><ul><li>普段の自然な歩行を基本とする</li><li>歩き始め直後と停止直前を避ける</li><li>最低2〜3周期、可能なら3〜5周期</li><li>1動画ではカメラ側下肢のみを正式解析</li><li>左右比較は右側面・左側面の2本を撮影</li><li>麻痺側設定時は麻痺側をカメラ側へ</li></ul></section>
